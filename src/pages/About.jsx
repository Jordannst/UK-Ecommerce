    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="text-center mb-16">
        <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
          About UNKLAB Campus Store
        </h1>
        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          Your one-stop platform for authentic UNKLAB merchandise and local products from Sulawesi Utara
        </p>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-600 text-lg leading-relaxed mb-4">
              UNKLAB Campus E-Commerce adalah platform resmi yang menghubungkan mahasiswa, alumni, 
              dan masyarakat dengan produk-produk berkualitas dari Universitas Klabat dan sekitarnya.
            </p>
          ...
          <div className="card p-8 bg-gradient-to-br from-unklab-blue to-blue-900 text-white">
      ...
      <section className="mb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="card p-8 text-center">
            <div className="w-16 h-16 bg-unklab-light rounded-xl flex items-center justify-center mx-auto mb-4">
      ...
      {/* CTA Section */}
      <section className="bg-gradient-to-r from-unklab-blue to-blue-900 rounded-3xl p-12 text-white text-center">
