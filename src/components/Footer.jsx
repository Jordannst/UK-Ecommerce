        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-600">
              Platform e-commerce modern untuk berbagai kebutuhan belanja Anda.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/shop" className="text-sm text-gray-600 hover:text-starg-pink transition-colors">
                  Belanja
                </Link>
              </li>
              <li>
                <Link to="/categories" className="text-sm text-gray-600 hover:text-starg-pink transition-colors">
                  Kategori
                </Link>
              </li>
              <li>
                <Link to="/about" className="text-sm text-gray-600 hover:text-starg-pink transition-colors">
                  Tentang Kami
                </Link>
              </li>
              <li>
                <Link to="/dashboard" className="text-sm text-gray-600 hover:text-starg-pink transition-colors">
                  Akun Saya
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#" className="text-sm text-gray-600 hover:text-starg-pink transition-colors">
                  Pusat Bantuan
                </a>
              </li>
              <li>
